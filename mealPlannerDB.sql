...
CREATE TABLE ingredients_allergens(
	ingredient_allergen_code NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	ingredient_allergen VARCHAR(12) NOT NULL
);
...
CREATE TABLE ingredients (
	...
	ingredient_type VARCHAR(12) DEFAULT NULL,
	ingredient_allergen VARCHAR(12) DEFAULT NULL,
	FOREIGN KEY (ingredient_type) REFERENCES ingredients_types (ingredient_type_code),
	FOREIGN KEY (ingredient_allergen) REFERENCES ingredients_allergens (ingredient_allergen_code)
...
CREATE TABLE schedules (
	...
	user_code NUMBER,
	days NUMBER,
	FOREIGN KEY (user_code) REFERENCES users_accounts (user_code) 
);
...
--Start adding predetermined information and case study user--